...
def load_dataset(path, p=None, mode='train'):
    ...
    unused_list = ['[unused1]', '[unused2]', '[unused3]', '[unused4]']
...
if __name__ == '__main__':
    ...
    patterns = ['学到很多！', '知识，技巧。', '学会啦！', '小知识。', None]

    if args.mode == 'train':
        train_data = load_dataset(args.data_dir + 'train.txt', p=patterns[args.pattern])
        dev_data = load_dataset(args.data_dir + 'dev.txt', p=patterns[args.pattern], mode='dev')
